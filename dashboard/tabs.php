    ...
    <div class="layout">
      ...
      <div class="page-container">
				...
				<div class="main-content">
					...
					<div class="page-title"><h4>Tabs</h4></div>
					...
					<div class="row">
						<div class="col-md-6">
								...
								<div class="card-block">
									...
									<div class="tab-info">
										<ul class="nav nav-tabs" role="tablist">
											<li class="nav-item"><a href="#default-tab-1" class="nav-link active" role="tab" data-toggle="tab">Home</a></li>
											<li class="nav-item"><a href="#default-tab-2" class="nav-link" role="tab" data-toggle="tab">Profile</a></li>
											<li class="nav-item"><a href="#default-tab-3" class="nav-link" role="tab" data-toggle="tab">Setting</a></li>
										</ul>
										
										<div class="tab-content">
											<div class="tab-pane fade in active" id="default-tab-1">
							...
							<div class="card">
								<div class="padding-20"><h4 class="card-title no-mrg-btm">Card Tabs</h4></div>
								
								<div class="tab-info">
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item"><a href="#card-tab-1" class="nav-link active" role="tab" data-toggle="tab">Home</a></li>
										<li class="nav-item"><a href="#card-tab-2" class="nav-link" role="tab" data-toggle="tab">Profile</a></li>
										<li class="nav-item"><a href="#card-tab-3" class="nav-link" role="tab" data-toggle="tab">Setting</a></li>
									</ul>
							...
							<div class="card">
								...
								<div class="tab-info center-tabs ">
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item"><a href="#tab-centered-1" class="nav-link active" role="tab" data-toggle="tab">Home</a></li>
										<li class="nav-item"><a href="#tab-centered-2" class="nav-link" role="tab" data-toggle="tab">Profile</a></li>
										<li class="nav-item"><a href="#tab-centered-3" class="nav-link" role="tab" data-toggle="tab">Setting</a></li>
									</ul>
                                ...
                                <div class="card">
                                    ...
                                    <div class="tab-primary">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-primary-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-primary-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-primary-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                ...
                                <div class="card">
                                    ...
                                    <div class="tab-success">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-success-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-success-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-success-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                ...
                                <div class="card">
                                    ...
                                    <div class="tab-info">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-info-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-info-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-info-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                ...
                                <div class="card">
                                    ...
                                    <div class="tab-warning">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-warning-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-warning-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-warning-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                ...
                                <div class="card">
                                    ...
                                    <div class="tab-danger">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-danger-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-danger-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="tabs.html#tab-danger-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="tab-primary">
                                            <ul class="nav nav-pills" role="tablist">
                                                <li class="nav-item">
                                                    <a href="tabs.html#nav-pills-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#nav-pills-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#nav-pills-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="pill-info nav-vertical nav-stacked">
                                            <ul class="nav nav-pills" role="tablist">
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-vertical-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-vertical-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-vertical-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="pill-success">
                                            <ul class="nav nav-pills" role="tablist">
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-success-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-success-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-success-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="pill-info">
                                            <ul class="nav nav-pills" role="tablist">
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-info-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-info-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-info-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="pill-warning">
                                            <ul class="nav nav-pills" role="tablist">
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-warning-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-warning-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-warning-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="pill-danger">
                                            <ul class="nav nav-pills" role="tablist">
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-danger-1" class="nav-link active" role="tab" data-toggle="tab">Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-danger-2" class="nav-link" role="tab" data-toggle="tab">Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="tabs.html#pills-danger-3" class="nav-link" role="tab" data-toggle="tab">Setting</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                ...
                                <div id="accordion-1" class="accordion panel-group" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingOne">
                                            <h4 class="panel-title">
									                <a data-toggle="collapse" data-parent="#accordion-1" href="tabs.html#collapseOne">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingTwo">
                                            <h4 class="panel-title">
									                <a class="collapsed" data-toggle="collapse" data-parent="#accordion-1" href="tabs.html#collapseTwo">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingThree">
                                            <h4 class="panel-title">
									                <a class="collapsed" data-toggle="collapse" data-parent="#accordion-1" href="tabs.html#collapseThree" >
                                ...
                                <div id="accordion-2" class="accordion panel-group" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="heading-2-One">
                                            <h4 class="panel-title">
									                <a class="collapsed" data-toggle="collapse" data-parent="#accordion-2" href="tabs.html#collapse-2-One">
									                    <span>Lando Calrissian</span>
									                    <i class="icon ti-arrow-circle-down"></i> 
									                </a>
									            </h4>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="heading-2-Two">
                                            <h4 class="panel-title">
									                <a data-toggle="collapse" data-parent="#accordion-2" href="tabs.html#collapse-2-Two">
									                    <span>Grand Moff Tarkin</span> 
									                    <i class="icon ti-arrow-circle-down"></i> 
									                </a>
									            </h4>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="heading-2-Three">
                                            <h4 class="panel-title">
									                <a  data-toggle="collapse" data-parent="#accordion-2" href="tabs.html#collapse-2-Three">
									                    <span>Mon Calamari </span> 
									                    <i class="icon ti-arrow-circle-down"></i> 
									                </a>
									            </h4>

      ...
      <div class="page-container">
        ...
        <div class="main-content">
          <div class="container-fluid">
            ...
            <div class="page-title"><h4>Recepção/Balcão</h4></div>
                    ...
                    <div class="email-wrapper row ml-0">
                      ...
                      <div class="email-content">                       
                        <div class="email-content-wrapper">
                              ...
                              <ul class="tools">
                                <li class="font-size-13 info p-0">
                                  <span class="title font-size-16" style="float:left; width:100%;"><b>BANCO</b></span>
                                  <span class="sub-title" style="float:left; width:100%;">341</span>
                                </li>

                                <li class="font-size-13 info p-0">
                                  <span class="title font-size-16" style="float:left; width:100%;"><b>AGENCIA</b></span>
                                  <span class="sub-title" style="float:left; width:100%;">34XX</span>  
                                </li>

                                <li class="font-size-13 info p-0" style="border-right: 1px solid #DDD;">
                                  <span class="title font-size-16" style="float:left; width:100%;"><b>CONTA</b></span>
                                  <span class="sub-title" style="float:left; width:100%;">0987XX-X</span>    
                                </li>

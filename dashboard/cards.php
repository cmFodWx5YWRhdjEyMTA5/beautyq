      ...
      <div class="page-container">
        ...
        <div class="main-content">
          <div class="container-fluid">
            ...
            <div class="page-title"><h4>Cards</h4></div>
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-block">
                    ...
                    <div class="mrg-top-20">
                      ...
                      <div class="mrg-top-25"><a href="" class="btn btn-primary no-mrg-btm">Action 1</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card">
                  <div class="card-heading"><h4 class="card-title">Default Card</h4></div>
                  ...
                  <div class="card-footer border top">
                    <ul class="list-unstyled list-inline text-right pdd-vertical-5">
                      <li class="list-inline-item"><a href="" class="btn btn-flat">Action 1</a></li>
                      <li class="list-inline-item"><a href="" class="btn btn-flat">Action 2</a></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-lg-3">
                <div class="card">
                  <div class="card-media"><img class="img-responsive" src="assets/images/others/img-3.jpg" alt=""></div>
                  
                  <div class="card-block">
                    <h4 class="mrg-btm-20 no-mrg-top">Card With Image</h4>
                    <p>All right! Up! Move! Come on! Quickly! Quickly, Chewie. Han! Hurry! The fleet will be here any moment. Charges! Come on, come on! Oh, my! They'll be captured! Wa-wait! Wait, come back! Artoo, stay with me. Freeze! You Rebel scum.</p>
                    <div class="mrg-top-40"><a href="" class="btn btn-info no-mrg-btm">Read More</a></div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-3">
                <a href="" class="card">
                  ...
                  <div class="card-media"><img class="img-responsive" src="assets/images/others/img-4.jpg" alt=""></div>
                  <div class="card-block">
